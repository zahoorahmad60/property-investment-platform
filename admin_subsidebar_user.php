...
<div class="side-nav side-nav-active" style="position: fixed; top: 0; left: -250px; width: 200px; height: 100%; background-color: #1f2c46; color: #E0E0E0; padding: 80px 20px 20px 20px; box-shadow: 4px 0 10px rgba(0, 0, 0, 0.5); transition: left 0.3s ease; z-index: 999; margin-top: 20px;">
  ...
  <ul style="list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column;">
    ...
    <li style="margin-bottom: 10px;"><a href="investor.php" style="color: #E0E0E0; text-decoration: none; padding: 10px; display: block; transition: background-color 0.3s, color 0.3s;">Investor</a></li>
    <li style="margin-bottom: 10px;"><a href="seller.php" style="color: #E0E0E0; text-decoration: none; padding: 10px; display: block; transition: background-color 0.3s, color 0.3s;">Seller</a></li>
    <li style="margin-bottom: 10px;"><a href="consultant.php" style="color: #E0E0E0; text-decoration: none; padding: 10px; display: block; transition: background-color 0.3s, color 0.3s;">Consultant</a></li>
