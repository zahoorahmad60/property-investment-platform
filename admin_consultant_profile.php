        ...
        <table>
            ...
            <tbody>
                <?php foreach ($consultations as $consultation): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($consultation['session_number']); ?></td>
                        <td><?php echo htmlspecialchars($consultation['date']); ?></td>
                        <td><?php echo htmlspecialchars($consultation['time']); ?></td>
                        <td><?php echo htmlspecialchars($consultation['investor_fname'] . " " . $consultation['investor_lname']); ?></td>
                        <td><?php echo htmlspecialchars($consultation['status']); ?></td>
                        <td><?php echo htmlspecialchars($consultation['zoom_link']); ?></td>
                        <td><?php echo htmlspecialchars($consultation['rating']); ?></td>
                        <td><?php echo htmlspecialchars($consultation['feedback']); ?></td>
                        <td><?php echo htmlspecialchars($consultation['rejection_reason']); ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
        <?php else: ?>
            <p>No consultations found for this consultant.</p>
        <?php endif; ?>
    </div>
</div>
</body>
