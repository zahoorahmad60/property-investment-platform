    ...
    if ($count > 0) {
        ...
        if ($row['approve'] == 1) {
            ...
            if (password_verify($password, $row['password'])) {
                ...
                header("Location: admin_property_management.php");
...
?>
    <div class="container">
        ...
        <p>As an Admin, you can manage different Properties 1. Apartments  2. Skyscrapers   3. Beach Villas .</p>
    </div>
    <?php include 'admin_propert_subbar.php'; ?>
    <script>
    function toggleSidebar() {
        const sidebar = document.querySelector('.side-nav');
        if (sidebar.style.left === '0px') {
