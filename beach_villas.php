    ...
    <script>
        ...
        function handleInvestClick(propertyId) {
            ...
            <?php else: ?>
                ...
                window.location.href = 'invest_property.php?type=beach_villa&id=' + propertyId;
            <?php endif; ?>
        }
    </script>
</head>
                ...
                <?php foreach ($beach_villas as $villa): ?>
                    <div class="property-card">
                        ...
                        <div class="button-group">
                            <button class="invest-button" onclick="handleInvestClick('<?php echo $villa['property_ID']; ?>')">Invest Now</button>
