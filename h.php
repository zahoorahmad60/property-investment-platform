    ...
    <main>
        <div class="content-card">
            ...
            <div class="button-group">
                <a href="apartments.php"><button>Invest Now</button></a>
                <a href="consultant.php"><button>Ask a Consultant</button></a>
            </div>
        </div>
        ...
        <div class="content-card">
            ...
            <div class="button-group">
                <a href="skyscrapers.php"><button>Invest Now</button></a>
                <a href="consultant.php"><button>Ask a Consultant</button></a>
            </div>
        </div>
        ...
        <div class="content-card">
            ...
            <div class="button-group">
                <a href="beach_villas.php"><button>Invest Now</button></a>
                <a href="consultant.php"><button>Ask a Consultant</button></a>
